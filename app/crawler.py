"""Site-2 manga board crawler/downloader.

Refactored from the original standalone script (``cwraling_download_manga_img_site2.py``).
Targets a specific Korean manga-board CMS layout: ``/bbs/board.php?bo_table=toons``
listing pages, with a per-post ``var img_list = [...]`` JS array holding image URLs.
